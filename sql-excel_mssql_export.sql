...
-- Examples:
EXEC  master..xp_cmdshell 'SQLCMD -S SEINT657 -d MediusFlow -E -Q "set nocount on;SELECT * FROM Table_Name" -o "C:\temp\export\test.csv" -h-1 -s"," -w 700', no_output
EXEC  master..xp_cmdshell 'SQLCMD -S SEINT657 -d MediusFlow -E -Q "set nocount on;SELECT * FROM Table_Name" -o "C:\temp\export\test.csv" -s"," -w 700', no_output
EXEC  master..xp_cmdshell 'SQLCMD -S SEINT657 -d MediusFlow -E -Q "SELECT * FROM Table_Name" -b -o C:\temp\export\test.csv'
EXEC  master..xp_cmdshell 'SQLCMD -S SEINT657 -d MediusFlow -E -Q "SELECT * FROM Table_Name" -o C:\temp\export\test.csv -s"," -w 700'
EXEC  master..xp_cmdshell 'SQLCMD -S SEINT657 -E -Q "SELECT * FROM [Database_Name].[dbo].[Table_Name]" -b -o C:\temp\export\test.csv', no_output
